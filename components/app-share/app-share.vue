				...
				<view class="share-box">
					<view class="share-list-box x-f">
						...
						<button class="share-item share-btn y-f" open-type="share">
							<image class="share-img" src="https://cfzx.gzfzdev.com/movie/uploadFiles/image/share_wx.png" mode=""></image>
						...
						<view
							...
							"
						>
							<image class="share-img" src="https://cfzx.gzfzdev.com/movie/uploadFiles/image/share_poster.png" mode=""></image>
							<text class="share-title">分享海报</text>
						</view>

						<view class="share-item y-f" @tap="copySharePath">
							<image class="share-img" src="https://cfzx.gzfzdev.com/movie/uploadFiles/image/share_link.png" mode=""></image>
