	...
	<view class="page_box">
		<view class="content_box">
			<scroll-view class="scroll-box" scroll-y enable-back-to-top scroll-with-animation @scrolltolower="loadMore">
				...
				<!-- 空白 -->
				<app-empty v-if="!grouponList.length && !isLoading" :emptyData="emptyData"></app-empty>
				<!-- 加载更多 -->
...
<style lang="scss">
.group-wrap {
	background: url('https://cfzx.gzfzdev.com/movie/uploadFiles/image/group_list_bg.png') no-repeat;
