		...
		<view class="content_box">
			...
			<radio-group @change="selPay" class="pay-box" v-if="payment">
				...
				<label class="x-bc pay-item" v-if="payment.includes('alipay')">
					<view class="x-f">
						<image class="pay-img" src="https://cfzx.gzfzdev.com/movie/uploadFiles/image/ali_pay.png" mode=""></image>
						<text>支付宝支付</text>
					</view>
				...
				<label class="x-bc pay-item" v-if="payment.includes('iospay') && !isAndroid">
					<view class="x-f">
						<image class="pay-img" src="https://cfzx.gzfzdev.com/movie/uploadFiles/image/apple_pay.png" mode=""></image>
						<text>ApplePay</text>
					</view>
