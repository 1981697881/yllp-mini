<template>
	<view>
		...
		<view class="score-price-card" v-if="type === 'score'">
			<view class="x-f">
				<image class="score-img" src="https://cfzx.gzfzdev.com/movie/uploadFiles/image/score.png" mode=""></image>
				<text class="price">{{ detail.price }}</text>
			</view>
			<view class="x-bc price-bottom-box">
				<view class="x-f">
...
.groupon-price-box {
	padding: 20rpx;
	background: url('https://cfzx.gzfzdev.com/movie/uploadFiles/image/group_price_bg.png') no-repeat;
	background-size: 100% 100%;
	.unit,
	.notice {
		font-size: 24rpx;
...
.score-price-card {
	padding: 20rpx;
	background: url('https://cfzx.gzfzdev.com/movie/uploadFiles/image/671e3bc4581f0b35791f382e4b5c2a8.png') no-repeat;
	background-size: 100% 100%;
	width: 750rpx;
	.notice {
		font-size: 24rpx;
